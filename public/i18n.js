(function (global) {
  const TRANSLATIONS = {
    ...
    'chat.help': 'Enter เพื่อส่ง · Shift + Enter ขึ้นบรรทัดใหม่',
      ...
      "ui.title": "5 เกมกระดาน",
      'hero.depth': 'เล่นเต็มมิติ 3D',
      'hero.play': 'เล่นเกมนี้',
      'hero.radio': 'เล่นไป ฟังวิทยุไทยไป',
      'hero.actual': 'ภาพจากเกมที่เล่นจริง',
      'hero.previewOptions': 'เลือกดูเกมอื่น',
      'hero.backThai': 'ดูหมากรุกไทย',
      'hero.previewThai': 'กระดานหมากรุกไทย 3D จากเกมที่เล่นจริง',
      'hero.previewChess': 'กระดานหมากรุกสากล 3D จากเกมที่เล่นจริง',
      "ui.subtitle": "หมุนกระดานได้ทุกมุม ชวนเพื่อนเล่นหรือฝึกกับ AI — เล่นฟรี ไม่ต้องสมัคร",
    ...
    'chat.help': 'Enter to send · Shift + Enter for a new line',
      ...
      "ui.eyebrow": "YOUR NEXT MOVE",
      "ui.title": "5 board games.",
      'hero.depth': 'Play in 3D.',
      'hero.play': 'Play this game',
      'hero.radio': 'Play along with Thai radio',
      'hero.actual': 'Actual in-game graphics',
      'hero.previewOptions': 'Explore more games',
      'hero.backThai': 'View Thai Chess',
      'hero.previewThai': 'Actual Thai chess game in 3D',
      'hero.previewChess': 'Actual international chess game in 3D',
      "ui.subtitle": "Explore every angle. Play with friends or practice with AI. Free, with no sign-up.",
      ...
      "game.checkers-intl": "English Checkers",
      "game.connect4": "Connect Four",
