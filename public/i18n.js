(function (global) {
  const TRANSLATIONS = {
    ...
    'chat.help': 'Enter เพื่อส่ง · Shift + Enter ขึ้นบรรทัดใหม่',
      ...
      "ui.local": "เล่นด้วยกันเครื่องเดียว", "ui.createLocal": "เริ่มเล่นบนเครื่องนี้", "ui.localHint": "นั่งด้วยกัน ผลัดกันเดินทั้งสองฝ่าย · หมุนกระดานได้ตามสะดวก", "local.player1": "ผู้เล่น 1", "local.player2": "ผู้เล่น 2",
    ...
    'chat.help': 'Enter to send · Shift + Enter for a new line',
      ...
      "ui.local": "Play on one device", "ui.createLocal": "Start on this device", "ui.localHint": "Sit together and take turns on one screen. Rotate the board whenever you like.", "local.player1": "Player 1", "local.player2": "Player 2",
      "ui.eyebrow": "YOUR NEXT MOVE",
